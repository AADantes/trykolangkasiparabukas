...
<div className="userInfo">
      ...
      <div className="upperRightRectangle">
          <div className="postContainer">
            ...
            <textarea
              ...
              placeholder="Commission Details/Content"
            />
            <button className="postButton" onClick={handlePostSubmit}>Post</button>
            <button className="paymentButton" onClick={handlePayment}>Set Amount for Service Payment</button>
          </div>
        </div>
      ...
      {showProfilePopup && (
        <div className="profilePopup">
          <div className="profileContent">
            <h2>Profile</h2>            
            <img
              src={selectedProfilePicture || userProfile.profilePicture || profileImage}
              alt="Profile"
              className="profilePicture"
            />
          </div>
